...
.price { font-weight:700; color:#0a9 }
@media (max-width:720px) { .detail { grid-template-columns: 1fr } }

.meta { list-style:none; padding:0; margin:0.5rem 0 }
.meta li { margin:0.25rem 0 }
.tag { display:inline-block; background:#eef; color:#036; padding:0.15rem 0.5rem; border-radius:999px; margin-right:0.4rem; font-size:0.9rem }
.actions { margin-top:0.75rem }
.actions button { background:#0a9; color:white; border:none; padding:0.5rem 0.75rem; border-radius:6px }
</style>
